...
class AgroUploader @Inject constructor(
    ...
    private val streamFetcher: AgroStreamFetcher
) {
    ...
    constructor(
        ...
        secureStorage,
        okHttpClient,
        AgroStreamFetcher(secureStorage, okHttpClient)
    )
     ...
     */
    fun fetch(contentHash: String): Result<okhttp3.Response> = streamFetcher.fetch(contentHash)
     ...
     */
    fun fetchP2POrRelay(track: MissingTrack): Result<FetchedStream> =
        streamFetcher.fetchP2POrRelay(track)
